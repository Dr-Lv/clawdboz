...
def start_web_chat(bots: dict, port: int = 8080, auth_token: str = None,
                   base_workplace: str = None, blocking: bool = False):
    """
    启动 Web 聊天界面
    ...
    Args:
        ...
        base_workplace: 基础 workplace目录路径（默认使用 CONFIG 中的配置）
        blocking: 是否阻塞运行（默认 False，后台线程模式）
